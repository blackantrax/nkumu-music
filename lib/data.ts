...
export const ARTISTS: Artist[] = [
  { id: 'diablit',      name: 'Diablit',           handle: '@Diablit',      genre: 'Rap / Drill',    certification: 'silver',   subscribers: 510,   streams: 82_000,    verified: true,  bio: "L'Authenticité Brute. Rappeur drill de Douala, fer de lance du collectif F.O.P. Son flow percutant et ses textes engagés définissent le son de la rue camerounaise.",  hue: 0,   location: 'Douala' },
  ...
  { id: 'simba-draken', name: 'Simba Draken',      handle: '@SimbaDraken',  genre: 'Trap / Afrorap', certification: 'bronze',   subscribers: 290,   streams: 31_000,    verified: true,  bio: "Rise & Shine. Produit par Winconcept Studio & Mezik Record, Simba Draken fusionne Trap, Afrorap et Pop avec un son moderne et international. De Magnetic à Briller, il incarne la montée en puissance d'une nouvelle génération.",  hue: 210, location: 'Douala' },
...
export const TRACKS: Track[] = [
  ...
  { id: 's1',  albumId: 'simba-vol1',   artistId: 'simba-draken', title: 'MAGNETIC',         durationSec: 225, priceXaf: 500, featuring: ['JKS'], streams: 14_200, monthlyStreams: 4_800, weeklyStreams: 1_400 },
  { id: 's2',  albumId: 'simba-vol1',   artistId: 'simba-draken', title: 'BRILLER',          durationSec: 220, priceXaf: 500, streams: 8_900,  monthlyStreams: 3_100, weeklyStreams:   820 },
  { id: 's3',  albumId: 'simba-vol1',   artistId: 'simba-draken', title: 'B.S.V',            durationSec: 260, priceXaf: 500, streams: 4_600,  monthlyStreams: 1_900, weeklyStreams:   510 },
  { id: 's4',  albumId: 'simba-vol1',   artistId: 'simba-draken', title: 'NEW DAY',          durationSec: 210, priceXaf: 500, streams: 3_300,  monthlyStreams: 1_200, weeklyStreams:   340 },
